...
function Signup({}) {
  ...
  if (
    ...
    submitButton = (
      <button
        type="submit"
        className="p-2 w-full bg-blue-400 
        text-white font-semibold text-lg rounded hover:bg-blue-600"
            ...
            <div className="p-2">
              {error && (
                <div className="flex founded text-white font-semibold items-center justify-centerp-2 bg-red-400">
                  ...
                  <XIcon className="w-2 h-2" onClick={() => setError(false)} />
                </div>
              )}
              <form onSubmit={handleSignupSubmit}>
                ...
                <div className="relative mt-3">
                  ...
                  <input
                    ...
                    className={`border border-slate-200 focus:border-blue-300 ${
                      emailErrorMessage && "border-red-300"
                    } p-2 outline-none w-full rounded`}
                  />
                  {emailErrorMessage && (
                ...
                <div className="relative mt-3">
                  ...
                  <input
                    ...
                    className={`border border-slate-200 focus:border-blue-300 ${
                      passwordErrorMessage && "border-red-300"
                    } p-2 outline-none w-full rounded`}
                  />
                </div>

                <div className="relative mt-4">{submitButton}</div>
              </form>
