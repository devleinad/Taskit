        ...
        <div className="flex space-x-1">
          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="flex justify-end items-center space-x-3">
              <button
                className="px-3 py-2  rounded-full text-md font-semibold hover:text-blue-500"
                onClick={customCancelFunc}
              >
                CANCEL
              </button>
              <button
                className="px-3 py-2 rounded text-md font-semibold  text-white bg-red-500 hover:bg-red-600"
