    ...
    <div className='flex flex-col justify-between h-screen  md:overflow-hidden oveflow-auto md:hover:overflow-auto pb-5'>
                  ...
                  isSidebarOpen && (
                    <div className='flex justify-between items-center px-1 mt-2'>
                      <div className='font-semibold text-2xl'>Taskit</div>
                        <button className='md:hidden text-xl rounded-full hover:bg-light-gray' onClick={() => {
                ...
                <div className='flex flex-col justify-between mt-5'>
                      ...
                      <div className='flex flex-col gap-4 text-sm'>
                        <Link href={'/projects'}>
                          <div className='flex items-center gap-3 py-1 rounded px-1 hover:bg-slate-100 cursor-pointer'
